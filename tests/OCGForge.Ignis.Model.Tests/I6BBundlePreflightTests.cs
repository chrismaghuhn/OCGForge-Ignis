...
internal static class I6BBundlePreflightTests
{
    ...
    // Historical value retained solely for the superseded-source rejection regression.
    private const string PreviousSourceCommit = "3edfcabf51dd914f96adc4df903b1ac2a9d20e5f";
    private const string ExpectedSourceCommit = "f929de0b4d4157327dba003067d2e21e42f7ad75";
    ...
    private const string ExpectedCanonicalSha256 =
        "7dd2750252c4682236e1157d6feff636ce0758fe0de52b183131958e41664117";
    private const string ExpectedBundleIdentity =
        "ocgforge-ignis.i6.model-contract-bundle.v1.7dd2750252c4682236e1157d6feff636ce0758fe0de52b183131958e41664117";
    private const string PreviousBundleIdentity =
    ...
    private const string ExpectedCanonicalHex =
        "0000002a6f6367666f7267652d69676e69732e69362e6d6f64656c2d636f6e74726163742d62756e646c652e76310000002a6f6367666f7267652d69676e6973" +
        "2e69362e6d6f64656c2d636f6e74726163742d62756e646c652e7631000000286639323964653062346434313537333237646261303033303637643265323165" +
        "343266376164373500000028336339396538366334383733363166633465306635663132363738623438363765353932333262370000000f0000002a6f636766" +
        "6f7267652e7075626c69635f656e7669726f6e6d656e745f6f62736572766174696f6e2e7631000000086f6367666f726765000101010000001d6f6367666f72" +
        "67652e7075626c69635f736166655f73746174652e7631000000086f6367666f72676500010100000000226f6367666f7267652e7075626c69635f616374696f" +
        "6e5f6964656e746974792e7631000000086f6367666f72676502010101000000236f6367666f7267652e7075626c69635f63616e6469646174655f646f6d6169" +
        "6e2e7631000000086f6367666f726765020101010000002d6f6367666f7267652e7075626c69635f73656d616e7469635f6465636973696f6e5f6964656e7469" +
        "74792e7631000000086f6367666f72676502010101000000206f6367666f7267652e657069736f6469635f656e7669726f6e6d656e742e7632000000086f6367" +
        "666f72676500010001000000206f6367666f7267652e656e7669726f6e6d656e745f6964656e746974792e7632000000086f6367666f72676502010101000000" +
        "1f6f6367666f7267652e6d6f64656c5f6c6f676963616c5f696e7075742e7631000000086f6367666f726765000101000000001f6f6367666f7267652e6d6f64" +
        "656c5f656e636f6465645f696e7075742e7631000000086f6367666f72676501010100000000216f6367666f7267652e6d6f64656c5f636172645f766f636162" +
        "756c6172792e7631000000086f6367666f72676502010101000000206f6367666f7267652e6d6f64656c5f696e7075745f6964656e746974792e763100000008" +
        "6f6367666f726765020101010000001e6f6367666f7267652e6d6f64656c5f62617463685f6c61796f75742e7631000000086f6367666f726765030001000000" +
        "00246f6367666f7267652e6d6f64656c5f7375706572766973696f6e5f73616d706c652e7631000000086f6367666f726765050001000000002e6f6367666f72" +
        "67652e7068617365362e7461736b372e696e7075745f6d6174657269616c697a6174696f6e2e7631000000086f6367666f72676503000100000000356f636766" +
        "6f7267652e7068617365362e7461736b372e696e7075745f6d6174657269616c697a6174696f6e5f636f6e6669672e7631000000086f6367666f726765020001" +
        "010000006d7068617365365f7461736b375f696e7075745f6d6174657269616c697a6174696f6e5f636f6e6669672e76312e3230663339346338383865393539" +
        "3434366661323633633335323066336464336231663438623361323365353833373364613731353361363931616231653761000000296f6367666f7267652d69" +
        "676e69732e72756e74696d652d62756e646c652d6964656e746974792e76310000002a6f6367666f7267652d69676e69732e69362e636f6d7061746962696c69" +
        "74792d70726f66696c652e7631";
    ...
    public static void TestCanonicalKat()
    {
        ...
        Require(bundle.Identity != PreviousBundleIdentity, "the superseded bundle identity remains active");
    }
    ...
    public static void TestManifestMismatchMatrix()
    {
        ...
        AssertRejected(
            CreateManifest(sourceCommit: PreviousSourceCommit),
            I6BErrorCode.SourceIdentityMismatch,
