...
public enum PerspectiveSafeI6C3ConstituentV1 : byte
{
    ...
    OverlayLocators = 2,
    OverlayIdentity = 3,
    XyzMaterialRelationships = 4,
    EquipRelationships = 5,
    TargetRelationships = 6,
    RelationshipEndpoints = 7,
    RelationshipOrdering = 8,
    ChainTriggerMetadata = 9,
    ChainLength = 10,
    ChainIndexMapping = 11,
    ChainLinkOrder = 12,
    ChainActivatingPlayer = 13,
    ChainSourceLocator = 14,
    ChainActivationZone = 15,
    ChainEffectDescription = 16,
    ChainTargets = 17
}
